...
{
    if (fullscreen)
        glfwSetWindowMonitor(window, glfwGetPrimaryMonitor(), 0, 0, properties.width, properties.height, properties.refreshRate);
    else
        glfwSetWindowMonitor(window, nullptr, 0, 0, properties.width, properties.height, properties.refreshRate);
